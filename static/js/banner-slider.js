/**
 * Beauty Shop - Banner Slider
 * Автоматичний слайдер для банерів з можливістю ручного керування
 */
...
class BannerSlider {
    ...
    init() {
        if (this.totalSlides <= 1) {
            // Ховаємо навігацію якщо тільки один слайд
    ...
    bindEvents() {
        ...
        // Пауза автопрокрутки при наведенні
        ...
        // Пауза при втраті фокусу сторінки
    ...
    goToSlide(slideIndex) {
        // Видаляємо активний клас з поточного слайду
        this.slides[this.currentSlide].classList.remove('active');
        
        // Оновлюємо індекс
        this.currentSlide = slideIndex;
        
        // Додаємо активний клас до нового слайду
    ...
    addSlide(imageUrl, altText) {
        ...
        slide.innerHTML = `<img src="${imageUrl}" alt="${altText}" class="banner-image">`;
...
document.addEventListener('DOMContentLoaded', function() {
    // Ініціалізуємо банерний слайдер
    const bannerSlider = new BannerSlider('bannerSlider');
    
    // Зберігаємо посилання для можливого використання в інших скриптах
    window.beautyShopBannerSlider = bannerSlider;
});
